...
#MEET_PALS_CATEGORY_ID ='1488387511607885864'

MEET_PALS_EXCLUDED_CHANNEL_NAMES = ['lgbtq🏳🌈', 'bipoc-chat🫶']

#Patreon role IDs

TSW_PATREON_TIER_ROLE_ID = int(1488848457610428538)
NBB_PATREON_TIER_ROLE_ID = int(1293250262752034928)
CCL_PATREON_TIER_ROLE_ID = int(1293249731803222088)

ONE_TIME_PATREON_ONBOARDING_BLAST = False